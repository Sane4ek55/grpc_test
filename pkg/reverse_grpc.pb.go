...
type ReverseClient interface {
	Do(ctx context.Context, in *RequestReverse, opts ...grpc.CallOption) (*ResponseReverse, error)
}
...
func (c *reverseClient) Do(ctx context.Context, in *RequestReverse, opts ...grpc.CallOption) (*ResponseReverse, error) {
	out := new(ResponseReverse)
	err := c.cc.Invoke(ctx, "/Sane4ek55.grpc_test.api.Reverse/Do", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReverseServer interface {
	Do(context.Context, *RequestReverse) (*ResponseReverse, error)
...
func (UnimplementedReverseServer) Do(context.Context, *RequestReverse) (*ResponseReverse, error) {
...
func _Reverse_Do_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/Sane4ek55.grpc_test.api.Reverse/Do",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReverseServer).Do(ctx, req.(*RequestReverse))
	}
...
var Reverse_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "Sane4ek55.grpc_test.api.Reverse",
